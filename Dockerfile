...
CMD ["sh", "-c", "export DATABASE_URL='file:/app/data/production.db' && npx prisma migrate deploy --schema=./prisma/schema.prisma && npx prisma generate --schema=./prisma/schema.prisma && node dist/main.js"]